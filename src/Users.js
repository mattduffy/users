 ...
 * @param { Object } properties - An object literal containing properties to be assigned to the
 *                                new user instance.
 * @return { User } - A new (unsaved) instance of User.
 */
function createNewBasicUser(properties = {}) {
  debug('Creating a new basic user')
  if (!Object.prototype.hasOwnProperty.call(properties, 'first')
    || !Object.prototype.hasOwnProperty.call(properties, 'last')
    || !Object.prototype.hasOwnProperty.call(properties, 'emails')
    || !Object.prototype.hasOwnProperty.call(properties, 'password')) {
...
function createNewAdminUser(adminProperties = {}) {
  ...
  if (!Object.prototype.hasOwnProperty.call(adminProperties, 'first')
    || !Object.prototype.hasOwnProperty.call(adminProperties, 'last')
    || !Object.prototype.hasOwnProperty.call(adminProperties, 'emails')
    || !Object.prototype.hasOwnProperty.call(adminProperties, 'password')) {
    let msg = 'The following fields are required to create a new user:\n'
    msg += '    - first: new user\'s first name.\n'
    msg += '    - last: new user\'s last name.\n'
